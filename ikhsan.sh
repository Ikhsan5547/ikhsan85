...
if [ $name = 'Ikhsan' ]
then
echo $green" [•] User Name Benar"
sleep 4
else
echo $red" [•] User Name Salah"
sleep 4
sh ikhsan.sh
sleep 3
...
if [ $pass = 'Editor' ]
then
echo $green" [•] Kata Sandi Benar"
sleep 4
else
echo $red" [•] Kata Sandi Salah"
sleep 3
sh ikhsan.sh
sleep 3
...
echo $black"Info Device Kamu"
neofetch
sleep 3
clear
sleep 1

echo $cyan"Join Wa Dulu Bro"
xdg-open https://chat.whatsapp.com/GpwaG5nvU2yCitgJ7c8o8f
clear

sleep 2
echo
toilet -f big -F gay Tools Ikhsan
echo $green"Selamat Datang"
echo
date
echo
sleep 2
echo $yellow"Silakan Pilih Tools Di Bawah Ini:"
echo
echo $yellow"Donasi:Pulsa
                   :XL:081938681806
                   :Axis:083137750223"
echo
echo
echo $purple "[Tools Halal] Halal. Tools Al-Quran"
echo
echo
sleep 3 
echo
echo $purple"15.Bot Telegram"
echo
echo $cyan"14.Nomor Bot Wa terbaru"
echo
echo $green"13.Deface"
echo
echo $cyan"12.Install Spam Wa"
echo
echo $red"11.Install OSIF(Open Source Information Facebook)"
echo
echo $purple"10.Game Gabut :V"
echo
echo $cyan"9.install ubuntu"
echo
echo $green"8.LiteDDOS"
echo
echo $red"7.Info Hadware"
echo
echo $yellow"6.Link Mod Apk"
echo
echo $purple"5.Video Dosa(18+)"
echo
echo $red"4.install Dark_FB Gold"
echo
echo $green"3. Nuklir Code(Dilarang untuk anak kecil:V )"
echo
echo $purple"2.Sc Wa Bot"
echo
...
if [ $Bro = Halal ] || [ $Bro = Halal ]
then
clear
toilet -f big -F gay Al-Quran
sleep 2
echo $blue"Selamat Mengaji"
sleep 2
apt update && apt upgrade
pkg install git
pkg install python
git clone https://github.com/Sxp-ID/Al-Quran
cd Al-Quran
...
then
clear
toilet -f big -F gay Bot Telegram
sleep 3
echo $blue"Tunggu Bro"
sleep 2
pkg upgrade && pkg update
pip install pyTelegramBotAPI
git clone https://github.com/Ikhsan5547/pyTelegramBotAPI
pkg install php
cd TelegramBot
...
then
clear
toilet -f big -F gay Nomor Bot
sleep 3
echo $green"Nomor Bot Kamis 23 Juni 2022"
sleep 2
echo
echo $cyan "1. wa.me/6288227217418[Delta Bot]"
sleep 2
echo
echo $cyan "2. wa.me/6285770089243[Chinata Eru Bot]"
sleep 2
echo
echo $cyan "3. wa.me/6281347206658[Fahzz Bot]"
sleep 2
echo
echo $cyan "4. wa.me/6288213292687[JOJO-Md]"
sleep 2
echo
echo $cyan "5. wa.me/6283867187689[Sakura-Bot]"
sleep 2
echo
echo $cyan "6. wa.me/79516408504[Findi-Bot]"
echo
read -p "Pilih Mana:" wa
...
then
clear
toilet -f big -F gay Deface
sleep 3
echo $cyan"Sc By otLock"
sleep 2
echo
echo $green
...
then
clear
toilet -f big -F gay Spam Wa
sleep 3
echo $green"Sc By FreeTutorial"
echo
echo $green"Subscribe Dulu Chanelnya Bro"
xdg-open https://youtube.com/channel/UCLRXFyMN0L8yH9F-xxOd7Og
sleep 4
echo $green
git clone https://github.com/Sxp-ID/spam-whatsappv2
echo
echo $green"Setelah Itu Unduh Tokennya"
sleep 4
xdg-open https://bit.ly/TokenSpamWhatsAppV2
sleep 5
cd spam-whatsappv2
sleep 3
python spam.py
...
sleep 3
echo $cyan"Tunggu Bro Lagi Install Bahan²nya"
sleep 4
echo
echo $cyan
pkg install python2
...
then
clear
toilet -f big -F gay ubuntu
echo $cyan"Tunggu Bro"
sleep 5
echo
apt update
apt install git
...
then
clear
toilet -f big -F gay Info Hadware
echo $white"Tunggu Bro"
sleep 3
echo
echo
...
then
clear
toilet -f big -F gay Video Dosa
echo $cyan"Dosa Ditanggung Sendiri"
sleep 3
echo $cyan"http://164.68.127.15/?id=Sma"
sleep 3
echo
echo $cyan"https://www.mediafire.com/file/h2nygxbyb6n9cyo/VID-20210107-WA1468.mp4/file"
sleep 3
echo
echo $cyan"https://www.mediafire.com/file/pk8hozohzdc076c/VID-20210107-WA1466.mp4/file"
sleep 3
echo
echo $cyan"https://www.mediafire.com/file/112q3u286tnvzjo/VID-20210107-WA1467.3gp/file"
sleep 3
echo
echo $cyan"https://www.mediafire.com/file/arpphhxsv94ak0r/VID-20210107-WA1462.mp4/file"
sleep 3
echo
echo $cyan"https://www.mediafire.com/file/us3f4j62emftbrf/VID-20210107-WA1463.mp4/file"
sleep 3
echo
echo $cyan"https://www.mediafire.com/file/v4033tkl16hgf2b/VID-20210107-WA1459.mp4/file"
sleep 3
echo
echo $cyan"https://www.mediafire.com/file/3scnim6d1x4b8ie/VID-20210107-WA1461.mp4/file"
sleep 3
echo
echo $cyan"https://www.mediafire.com/file/dx9tklonu0eq36w/VID-20210107-WA1464.mp4/file"
sleep 3
echo
echo $cyan"https://www.mediafire.com/file/snwja297dv4zvtl/VID-20210107-WA0036.mp4/file"
sleep 3
echo
echo $cyan"https://www.mediafire.com/file/arpphhxsv94ak0r/VID-20210107-WA1462.mp4/file"
sleep 3
echo
echo $cyan"Itu Aja Bro :)"
exit
...
then
clear
toilet -f big -F gay Dark_FB
echo $cyan Tunggu Sebentar Coy
sleep 5
pkg update && pkg upgrade
pkg install python
pip2 install requests
pip2 install mecanize
git clone https://github.com/TechnicalAli433/Dark-FB-Gold
cd Dark-FB-Gold
python2 Dark-FB-Gold
...
then
clear
toilet -f big -F gay Nuklir Code
echo $green"Nuklir Code"
sleep 5
echo $cyan"Gampang Mode :
...
then
clear
toilet -f big -F gay Sc Bot Wa
echo $cyan"Sc Bot Wa"
sleep 4
echo $cyan"1. https://telegra.ph/Haruka-Md-V1-06-20"
echo $cyan"2. https://github.com/riychdwayne/Chika-Md/tree/Chika-MdV8"
...
then
clear
toilet -f big -F gay Stabilkan Jaringan
